...
class SharePin extends Component {
  ...
  render() {
    ...
    const src = "https://maps.googleapis.com/maps/api/streetview?key=AIzaSyAqTbCi1cn63_xyUgVTSZ9yWvkJXjp2jUs&size=500x300&location=" + this.props.data.lat + "," + this.props.data.lng + "&heading=" + this.props.data.heading + "&pitch=" + this.props.data.pitch + "&fov=" + fov;
    return (
