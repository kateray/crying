...
class Magnify extends Component {
  ...
  render() {
    ...
    return (
      <Map className="pink-map" style={{height: height, top: this.props.top-height, left: this.props.left}} zoomControl={false} attributionControl={false} opacity={0.5} zoom={15} center={this.props.position}>
